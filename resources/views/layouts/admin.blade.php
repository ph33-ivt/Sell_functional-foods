        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm admin-nav">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/logo.jpg') }}" style="height: 65px">
                </a>
        ...
        <div class="row mx-0">
            <div class="col-md-2 p-0">
                <ul class="admin-left-nav">
                    <li><h4 class="admin-title-menu">Product</h4>
                        <ol>
                    ...
                    <li><h4  class="admin-title-menu">Order</h4>
                        <ol>
                            <li><a href='{{route("admin.order")}}'>Order</a></li>
                           <!--  <li><a href='{{route("admin.order.create")}}'>Add Order</a></li> -->
                        </ol>
                    </li>
                </ul>
            </div>
            <div class="col-md-10 py-5 pt-5 admin-main">
                @yield('content')
            </div>
        </div>
    </div>
